...
재정의 : 틀의 변화가 없고 (함수의 이름, 타입) 내용만 변환(중괄호 안에 실행코드 수정)
...
class Point3D extends Point2 {
	...
	// 새로운 함수를 생성한 것이 아니라 부모함수를 그대로 쓴 것 = overrider(재정의)
	// 내가 함수가 정말 재정의 인지 아닌지 검증하고 싶어요 
	
	// Annotation 
	/*
	 어노테이션은 사전적 의미로는 주석이라는 뜻이다. 
	 자바에서 사용될 때의 어노테이션은 코드 사이에 주석처럼 쓰여서 

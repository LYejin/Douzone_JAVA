...
//		score[5] = 600;
		...
		System.out.println();
		// java.util.Arrays 헬퍼클래스(도움을 주는 클래스) >> 당신이 필요한 다양한 함수 >> static 
...
//		Arrays.sort(score);
		...
		// 정렬 알고리즘 (신입 : 버블 정렬, 퀵 정렬, 정도는 알아야한다)
		
		//Today Point
		// 배열 만드는 3가지 방법 
		int[] arr = new int[5]; //기본
		int[] arr2 = new int[] {10,20,30,40,50}; // 초기값을 통해서 배열의 개수를 정의하고 값을 할당하겠다
		int[] arr3 = {11,22,33}; // 컴파일러가 알아서 new를 처리 ... 부탁 
		...
		System.out.println(arr4); //[I@18e8568 주소값을 가지고 있다 
